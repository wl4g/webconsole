// Generated by Automatic config_generator.go
...
const (
	defaultWebConsoleYamlConfigContent = `# Copyright 2017 ~ 2035 the original author or authors<Wanglsir@gmail.com, 983708408@qq.com>.
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
...
server:
  ...
  cors:
    ...
    max-age: 172800
  ssh2-term:
    # Options(ansi/linux/vt100/xterm/dumb) Except for dumb, all the others have color display, default: xterm
    pty-term-type: "xterm"
    pty-term-conn-timeout-sec: 5 # Seconds
    pty-ws-transfer-buffer-size: 8192
